...
class C37Receiver1P13A2D(Component):
    ...
    def on_clock(self):
        ...
        self.logger.info('on_clock():%s  and the angle_diff is %f and the digitals %s and %s', now, self.angle_diff, str(self.digitals1), str(self.digitals2))
    ...
    def on_data_queue(self):
        ...
        #        'timestamp': timestamp}
        data = {'start_time':on_clock_start, 'mag_diff':P1, 'angle_diff': P2, 'DIGITALS': digits, 'DIGITALS1': digits1}
        self.angle_diff = P2
