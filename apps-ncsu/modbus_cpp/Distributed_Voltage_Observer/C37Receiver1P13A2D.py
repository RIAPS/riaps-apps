...
class C37Receiver1P13A2D(Component):
    def __init__(self, pmu_ip, pmu_port):
        ...
        self.Q_breaker2 = 0
        self.In_breaker2 = 0        
        self.Vleft_breaker3 = 0
        self.Vright_breaker3 = 0
        self.Theta_breaker3 = 0
    ...
    def on_clock(self):
        ...
        print('on_clock():%s  and the vuf1 is %f,  P_breaker2 is %f, Q_breaker2 %f, In2_breaker2 %f, Vleft_breaker3 %f,  Vright_breaker3 %f, Theta_breaker3 %f, vuf2 %f , vuf3 %f  , vuf4 %f  , vuf5 %f ' %( now, self.vuf1,self.P_breaker2 ,self.Q_breaker2, self.In_breaker2,  self.Vleft_breaker3, self.Vright_breaker3, self.Theta_breaker3, self.vuf2, self.vuf3, self.vuf4, self.vuf5))
        
        # Delay the start to the next round. Give more time to the subscribes to connect.
        if self.started == False:
            self.started = True
        if self.started == True and self.readerThread == None:
    ...
    def on_data_queue(self):
        ...
        OFFSET_SOC = 6
        OFFSET_VALUES = 16
        FMT_VALUES = '!ff ff ffff ffff ffff f H H H H'  #'!ff(phase angle and mag) ff(f and df) ffff ffff ffff f(13 analogs) H H H(3 dig)' 
        ...
        #        'timestamp': timestamp}
        #data = {'start_time':on_clock_start, 'mag_diff':P1, 'angle_diff': P2, 'DIGITALS': digits, 'DIGITALS1': digits1, 'timestamp': timestamp, 'grid_v_mag': f1, 'grid_ph_angle': f2,'ugrid_v_mag': f3, 'ugrid_ph_angle': f4, 'ugrid_frequency': P3  }
        data = {'start_time':on_clock_start, 'DIGITALS': digits, 'DIGITALS1': digits1, 'DIGITALS2': digits2, 'DIGITALS3': digits3,'timestamp': timestamp, 'vuf1': f1, 'P_break2': f2, 'Q_break2': f3, 'In_breaker2': f4, 'Vleft_breaker3': P1, 'Vright_breaker3': P2, 'Theta_breaker3': P3, 'VUFleft_breaker3': P4, 'VUFright_breaker3': Q1, 'vuf2': Q2, 'vuf3': Q3, 'vuf4': Q4, 'vuf5': V2}
        self.vuf1 = f1
        self.P_breaker2 = f2
        self.Q_breaker2 = f3
        self.In_breaker2 = f4
        self.Vleft_breaker3 = P1
        self.Vright_breaker3 = P2
        self.Theta_breaker3 = P3
        self.vuf2 = Q2
        self.vuf3 = Q3
        self.vuf4 = Q4
        self.vuf5 = V2
