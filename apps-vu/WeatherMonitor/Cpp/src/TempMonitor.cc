...
namespace weathermonitor {
    namespace components {
        ...
        TempMonitor::TempMonitor(const py::object*  parent_actor     ,
            ...
            : TempMonitorBase(parent_actor, actor_spec, type_spec, name, type_name, args, application_name, actor_name, groups) {
...
PYBIND11_MODULE(libtempmonitor, m) {
    ...
    testClass.def("handleActivate"        , &weathermonitor::components::TempMonitor::HandleActivate);
